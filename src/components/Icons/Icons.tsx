...
export function IcRoundStar(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="22px" height="22px" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function IcRoundStarBorder(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="22px" height="22px" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
